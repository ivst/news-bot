...
Сервис автоматизации новостей: собирает свежие материалы из RSS по теме `TARGET_TOPIC`, переводит их, формирует краткие резюме и публикует в Telegram, VK и/или Ленту новостей Битрикс24 по расписанию.
